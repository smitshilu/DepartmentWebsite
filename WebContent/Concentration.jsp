...
<body>
	...
	<%
		DAO dao = new DAO();
	ArrayList<String> concentration = dao.getConcentration();
	%>
	...
	<div class="col-sm-5 form-box ">
		...
		<div class="form-bottom">
			<form role="form" action="Courses.jsp" method="post"
				class="registration-form center_div">

				<div class="form-group">
					<label style="color: white" class="" for="role">Concentration</label> <select
						class="form-control" name="concentration">
						<%
							for (int i = 0; i < concentration.size(); i++) {
						%>
						<option value="<%= concentration.get(i) %>"><%= concentration.get(i) %></option>
						<%
							}
						%>
					</select>
