...
<body>
	...
	<div class="col-sm-5 form-box ">
		...
		<div class="form-bottom">
			<%
				DAO dao = new DAO();
				ArrayList<ExamResultModel> exam = dao
						.getMyExamNames(((String) session.getAttribute("netid")));
			%>
			<table style="color: white">
				...
				<tr>
					<td><a
						href="ViewResultDetails.jsp?examid=<%=exam.get(i).getId()%>"><%=exam.get(i).getExamname()%></a></td>
