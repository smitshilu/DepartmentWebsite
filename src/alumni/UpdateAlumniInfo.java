...
/**
 * Servlet implementation class UpdateAlumniInfo
 */
@WebServlet("/UpdateAlumniInfo")
public class UpdateAlumniInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateAlumniInfo() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DAO dao = new DAO();
		try {
			if(dao.editAlumniInfo(alumniid, alumniname, alumniinfo, alumniurl)) {
